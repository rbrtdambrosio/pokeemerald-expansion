...
const u8 gText_ThisIsAPokemon[] = _("I st cos e' n POKEMONN'”{PAUSE 96}\p");
...
const u8 gText_easy[]= _("Animal Crossing"); //  RD edit
const u8 gText_medium[]= _("Super Mario"); 
const u8 gText_hard[]= _("Dark Souls");
