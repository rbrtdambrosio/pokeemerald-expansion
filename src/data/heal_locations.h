static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_STANZA_ALICE - 1] = {MAP_GROUP(STANZA_ALICE), MAP_NUM(STANZA_ALICE), 4, 4},
    [HEAL_LOCATION_ViaFrancigenaMiddleNORD_Mirtilli - 1] = {MAP_GROUP(VIA_FRANCIGENA_MIDDLE_NORD), MAP_NUM(VIA_FRANCIGENA_MIDDLE_NORD), 20, 2},
    [HEAL_LOCATION_ViaFrancigenaUpHill_Mirtilli - 1] = {MAP_GROUP(VIA_FRANCIGENA_UP_HILLS), MAP_NUM(VIA_FRANCIGENA_UP_HILLS), 12, 33},
    [HEAL_LOCATION_LagoWild_Mirtilli - 1] = {MAP_GROUP(LAGO_WILD_AREA), MAP_NUM(LAGO_WILD_AREA), 9, 12},
    [HEAL_LOCATION_CampoGizzi_Mirtilli - 1] = {MAP_GROUP(CAMPO_GIZZI_CASA_MAVI), MAP_NUM(CAMPO_GIZZI_CASA_MAVI), 31, 18},
    [HEAL_LOCATION_AUTOSTRADA_Mirtilli - 1] = {MAP_GROUP(AUTOSTRADA), MAP_NUM(AUTOSTRADA), 38, 12},
};
