...
static const u8 sPlayerAvatarGfxIds[][2] =
{
    ...
    //[PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_BRENDAN_MACH_BIKE,  OBJ_EVENT_GFX_MAY_MACH_BIKE_FIXED},
    //[PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,  OBJ_EVENT_GFX_MAY_ACRO_BIKE_FIXED},
   //------
...
static const u8 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    ...
    [FEMALE] =
    {
        ...
        //rd edit commenting and adding
       {OBJ_EVENT_GFX_MAY_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
       {OBJ_EVENT_GFX_MAY_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
       // {OBJ_EVENT_GFX_MAY_MACH_BIKE_FIXED, PLAYER_AVATAR_FLAG_MACH_BIKE},
        //{OBJ_EVENT_GFX_MAY_ACRO_BIKE_FIXED, PLAYER_AVATAR_FLAG_ACRO_BIKE},
//--------
